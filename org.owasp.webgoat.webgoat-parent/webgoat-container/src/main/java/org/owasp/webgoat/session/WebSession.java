...
public class WebSession {
	 ...
	 */
	public WebSession(final WebgoatContext webgoatContext, final ServletContext context) {
	 ...
	 */
	public static synchronized Connection getConnection(final WebSession s) throws SQLException {
	 ...
	 * @param s a {@link org.owasp.webgoat.session.WebSession} object.
	 */
	public static void returnConnection(final WebSession s) {
	...
	public void eatCookies() {
		...
		for (int loop = 0; loop < cookies.length; loop++) {
			if (!cookies[loop].getName().startsWith("JS") && !cookies[loop].getName().startsWith("!Proxy!redirectJS")) {// skip jsessionid
																														// cookie
				cookies[loop].setMaxAge(0);// mark for deletion by browser
				System.out.println("Deleting cookie:" + cookies[loop].getName());
	...
	/**
	 * <p>
	 * Setter for the field <code>course</code>.
	 * </p>
	 *
	 ...
	 * @param screen a int.
	 */
	public void setCurrentScreen(final int screen) {
	 ...
	 * @return a {@link org.owasp.webgoat.lessons.AbstractLesson} object.
	 */
	public AbstractLesson getLesson(final int id) {
	 ...
	 * @return a {@link java.util.List} object.
	 */
	public List<AbstractLesson> getLessons(final Category category) {
	...
	public List<Cookie> getCookies() {
		...
		/*
		 * List cookies = new Vector(); HttpServletRequest request = getRequest(); Cookie[] cookies = request.getCookies(); if (
		 * cookies.length == 0 ) { list.addElement( new LI( "No Cookies" ) ); } for ( int i = 0; i < cookies.length; i++ ) { Cookie cookie =
		 * cookies[i]; cookies.add(cookie); //list.addElement( new LI( cookie.getName() + " -> " + cookie.getValue() ) ); }
		 */
		return cookies;
	}
	 ...
	 */
	public String getWebResource(final String fileName) {
	...
	private final Map<AbstractLesson, LessonSession> lessonSessions = new Hashtable<>();
	 ...
	 * @return a boolean.
	 */
	public boolean isAuthenticatedInLesson(final AbstractLesson lesson) {
	 ...
	 * @return a boolean.
	 */
	public boolean isAuthorizedInLesson(final int employeeId, final String functionId) {
	 ...
	 * @return a boolean.
	 */
	public boolean isAuthorizedInLesson(final String role, final String functionId) {
	 ...
	 * @param lesson a {@link org.owasp.webgoat.lessons.AbstractLesson} object.
	 */
	public void openLessonSession(final AbstractLesson lesson) {
	 ...
	 * @param lesson a {@link org.owasp.webgoat.lessons.AbstractLesson} object.
	 */
	public void closeLessonSession(final AbstractLesson lesson) {
	 ...
	 */
	public LessonSession getLessonSession(final AbstractLesson lesson) {
	 ...
	 */
	public boolean isScreen(final int value) {
	 ...
	 */
	public void setLineBreak(final String text) {
	 ...
	 */
	public void update(final HttpServletRequest request, final HttpServletResponse response, final String name) throws IOException {
		String content = null;
		...
		/*
		 * if (myParser.getRawParameter(LOGOUT, null) != null) { System.out.println("Logout " + request.getUserPrincipal()); eatCookies();
		 * request.getSession().invalidate(); currentScreen = WELCOME; previousScreen = ERROR; }
		 */
		...
		if (getPreviousScreen() == WebSession.WELCOME || getRequest().getSession(false) != null && // getRequest().getSession(false).isNew()
																									// &&
				getCurrentScreen() == WebSession.WELCOME && getPreviousScreen() == WebSession.ERROR) {
	 ...
	 * @param request a {@link javax.servlet.http.HttpServletRequest} object.
	 */
	public void updateLastAttackRequestInfo(final HttpServletRequest request) {
		// store cookies
		Cookie[] cookies = request.getCookies();
		if (cookies == null) {
			cookiesOnLastRequest = new ArrayList<>();
		}
		else {
			cookiesOnLastRequest = Arrays.asList(cookies);
		}
		// store parameters
		Map<String, String[]> parmMap = request.getParameterMap();
		logger.info("PARM MAP: " + parmMap);
		if (parmMap == null) {
			parmsOnLastRequest = new ArrayList<>();
		}
		else {
			parmsOnLastRequest = new ArrayList<>();
	 ...
	 */
	public void restartLesson(final int lessonId) {
	 ...
	 * @param role a {@link java.lang.String} object.
	 */
	public void setHasHackableAdmin(final String role) {
	...
	/**
	 * <p>
	 * Setter for the field <code>currentMenu</code>.
	 * </p>
	 *
	 * @param ranking a {@link java.lang.Integer} object.
	 */
	public void setCurrentMenu(final Integer ranking) {
		currentMenu = ranking.intValue();
	}

	/**
	 * <p>
	 * Getter for the field <code>currentMenu</code>.
	 * </p>
	 *
	 * @return a int.
	 */
	...
	/**
	 * <p>
	 * Getter for the field <code>cookiesOnLastRequest</code>.
	 * </p>
	 *
	...
	/**
	 * <p>
	 * Getter for the field <code>parmsOnLastRequest</code>.
	 * </p>
	 *
